  ...
  torre.addEventListener("click", function () {
    ...
    if (torreSelecionada === null) {
      if (this.firstElementChild !== null) {
        ...
        blocoSelecionado.style.setProperty(
          "--move-y",
          `${-blocoSelecionado.offsetTop - 50}px`,
        );
...
function moverBloco(torreInicial, torreFinal, listaMovimentos) {
  ...
  movimentoValido =
    blocoTorreFinal === null ||
    Number(blocoSelecionado.innerText) < Number(blocoTorreFinal.innerText);
